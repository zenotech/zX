...
- The user must be able to choose which python hooks to execute (pre-processing, launch, extraction). Default to all hooks. Hooks should be executed in the order of pre-processing, launch, extraction.
